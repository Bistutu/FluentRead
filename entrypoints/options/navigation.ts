...
export const navigationGroups: NavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'settings-video', icon: 'CC', label: '视频字幕 Beta 测试', description: 'YouTube / X 边看边译', group: '阅读工具',
        heading: '边看边译视频字幕', summary: '翻译 YouTube / X 原生字幕；X 没有字幕时可主动请求本地 AI 字幕。',
        kicker: 'FluentRead 视频翻译 Beta 测试', title: 'FluentRead YouTube / X 视频字幕', detail: '原生字幕直接翻译；X 的 AI 字幕只在你主动请求后交给扩展内 Whisper 识别。',
        searchDescription: 'YouTube、X、Twitter、视频字幕、AI 字幕、本地 Whisper、视频翻译服务、DeepLX、微软翻译',
      },
    ],
  },
  {
